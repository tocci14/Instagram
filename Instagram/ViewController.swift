...
class ViewController: UIViewController {
    ...
    override func viewDidAppear(_ animated: Bool) {
        ...
        if FIRAuth.auth()?.currentUser == nil {
            ...
            // viewDidAppear内でpresent()を呼び出しても表示されないためメソッドが終了
    ...
    func setupTab()  {
        ...
        // 画像のファイル名を指定してESTabBarController
        ...
        // タブをタップした時に表示表示するViewControllerを設定する
        ...
        tabBarController.setAction({
            // ボタンが押されていたらImageViewControllerをボーダルで表示する
